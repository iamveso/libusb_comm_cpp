...
#define USB_VENDOR_GOOGLE 0x12d1
#define USB_PRODUCT_NEXUS_S 0x107e
...
private:
  ...
  const static uint8_t in_addr = 0x81;
  const static uint8_t out_addr = 0x01;
#ifndef _MSC_VER
  constexpr static array<uint32_t, 4> _pid {{0x2D00, 0x2D01, 0x2D04, 0x2D05}};
#else
